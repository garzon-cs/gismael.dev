...
export const Portfolio = () => {
    ...
    const { page_portfolio, batch_relevant, batch_freelance } = Strings;
    ...
    return (
        <main className='min-h-screen ml-2 mt-10 lg:m-20'>
            ...
            <span className='text-center text-lg'> {page_portfolio.wait} </span>

            <ProjectGroup
                groupTitle={batch_relevant.title}
                projects={batch_relevant.projects}
                className='mt-10 lg:mt-24 p-2'
            />

            <ProjectGroup
                groupTitle={batch_freelance.title}
                projects={batch_freelance.projects}
                className='mt-10 lg:mt-24 p-2'
            />
